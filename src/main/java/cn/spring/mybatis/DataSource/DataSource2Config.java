...
// */
//@Configuration
//@MapperScan(basePackages = "cn.hb.mybatis.dao.test2", sqlSessionTemplateRef  = "test2SqlSessionTemplate")
...
//        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:cn/hb/spring/mybatis/dao/test2/*.xml"));
